...
export default {
    ...
    tabLegend: "Legend",
    modByproductsTitle: "Recovered Byproducts",
    usesProducedFrom: "is produced from:",
    usesCanMake: "can be used to make:",
    usesSetTarget: "Set as Target",
    usesNone: "No known recipes or sources for",
    usesDetails: "Details",
    tabMaterials: "Materials",
    tabLegend: "Legend",
    usesTitle: "Material Details",
    btnClose: "Close",
    modByproductsTitle: "Recovered Byproducts",
    usesProducedFrom: "is produced from:",
    usesCanMake: "can be used to make:",
